...
4. Optionally set BUCKETT_TAG to a fixed release such as v0.1.6 for fully predictable updates
5. Deploy the stack

Most reliable update flow in Dockge:

1. Wait until the GitHub Actions image build has finished after push or release
2. In Dockge, change BUCKETT_TAG from the old version to the new version, for example from v0.1.5 to v0.1.6
